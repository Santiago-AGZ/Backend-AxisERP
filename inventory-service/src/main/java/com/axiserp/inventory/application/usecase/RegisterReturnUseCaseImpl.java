...
public class RegisterReturnUseCaseImpl implements RegisterReturnUseCase {
    ...
    @Override
    @Transactional
    public MovementResponse registerReturn(UUID productId, int quantity, String referenceType, UUID referenceId, String notes, UUID createdBy) {
        if (quantity <= 0) {
